class Employee:
    ...
    атрибут first_name, возвращающий имя, атрибут last_name, возвращающий фамилию
    атрибут salary, возвращающий зарплату

    функцию from_string, которая принимает имя, фамилию и зарплату в формате
    ...
    @classmethod
    def from_string(cls, str_parse):
        first_name, last_name, salary = str_parse.split('-')
